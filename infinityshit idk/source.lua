-- If you are reading this that means u need to go get a life or better yet get better at coding

-- okay nigger i have a life so shut you bitch ass
-- Mrbirdz was here.
...
local watermark     = library:Watermark("1NF1N17Y | 60 fps | 60ms | " .. script_version_number .. " | Free")
...
local main = library:Load{ Name = "1NF1N17Y - " .. script_version_number .. " - Last Updated: " .. last_updated .. " - Free", SizeX = 600, SizeY = 600, Theme = "Midnight", Extension = "json",  Folder = "1NF1N17Y-Configs" }
...
function InventoryViewer:Update()
    ...
    local Scan, _Players = {}, table.find(library.flags["inventoryscannerInventoryToScan"], "Players")
    if _Players then
...
ServiceConnections.RenderSteppedConnection = rs.RenderStepped:Connect(function()
    if Running and Alive(plr) then
        ...
        if updateTick >= 2 then
            ...
            watermark:Set("1NF1N17Y | " .. fps .. " fps | " .. ping .. "ms | " .. script_version_number .. " | Free")
